...
class Ion_auth
{
	 ...
	 * @author Ben Edmunds
	 **/
	public function is_accounting_manager($id=false) //is_user also same
	{
		$this->ion_auth_model->trigger_events('accounting_manager_group');
		$accounting_manager_group = $this->config->item('accounting_manager_group', 'ion_auth');		
		return $this->in_group($accounting_manager_group, $id);
	}
	 ...
	 * @author Ben Edmunds
	 **/
	public function is_kasier_manager($id=false) //is_user also same
	{
		$this->ion_auth_model->trigger_events('kasier_manager_group');
		$kasier_manager_group = $this->config->item('kasier_manager_group', 'ion_auth');		
		return $this->in_group($kasier_manager_group, $id);
	}
